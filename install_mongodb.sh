...
# Script to install MongoDB 8.0.9 using Ansible
# Author: Cline
# Date: 2025-05-21
...
# Display banner
echo "====================================================="
echo "MongoDB 8.0.9 Installation Script for Ubuntu 20.04"
echo "====================================================="
...
if [ $? -eq 0 ]; then
    echo "====================================================="
    echo "MongoDB 8.0.9 installation completed successfully!"
    echo "====================================================="
